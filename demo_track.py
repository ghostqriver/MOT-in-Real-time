...
def main(exp, args):
    ...
    predictor = Predictor(model, exp, trt_file, decoder, args.device, args.fp16) # predictor
...
if __name__ == "__main__":
    ...
    exp = get_exp(args.exp_file, args.name) # get exp description file and model name
